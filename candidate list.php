...
<div class="sidebar">
    ...
    <li><a href="#"><ion-icon name="settings"></ion-icon> Settings</a></li>
        ...
        <li><a href="message.php"><i class='bx bx-envelope'></i> Message <span><?php echo $messageCount; ?></span></a></li>
...
$sql = "SELECT cid, fname, lname, gender, address, dob, email, position, date FROM candidates";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    echo "<td>" . $row["date"] . "</td>";
    echo "<td>
      <a href='edit empl.php?cid=" . $row["cid"] . "'>Edit</a>
      <a href='?delete=" . $row["cid"] . "' onclick='return confirm(\"Are you sure you want to delete this canddt?\")'>Delete</a>
      </td>";
    echo "</tr>";
  }
  echo "</table>";
} else {
  echo "<table><tr><td colspan='10'>0 results</td></tr></table>";
}
